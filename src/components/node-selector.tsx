  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        label: "Text Splitter",
        description: "Split document text into smaller chunks for embedding",
        icon: SplitIcon,
      },
      {
        type: NodeType.INSERT_PINECONE,
        label: "Insert into Pinecone",
        description: "Embed and store text chunks in Pinecone vector database",
        icon: "/logos/pinecone.svg",
      },
      {
        type: NodeType.VECTOR_RETRIEVER,
        label: "Vector Retriever",
        description: "Search Pinecone for relevant context based on a query",
        icon: SearchIcon,
      },
      {
        type: NodeType.RAG_AGENT,
        label: "RAG Agent",
        description: "Generate context-aware AI answers using retrieved documents",
        icon: BrainCircuitIcon,
      },
      {
        type: NodeType.CHAT_MEMORY,
        label: "Chat Memory",
        description: "Store and retrieve conversation history for chatbot sessions",
